describe('Remove Liquidity', () => {
  ...
  it('does not crash if ETH is duplicated', () => {
    cy.visit(
      '/remove/v2/0xc778417E063141139Fce010982780140Aa0cD5Ab/0xc778417E063141139Fce010982780140Aa0cD5Ab',
    );
    cy.get('#remove-liquidity-tokena-symbol').should('contain.text', 'WETH');
  ...
  it('token not in storage is loaded', () => {
    cy.visit(
      '/remove/v2/0xb290b2f9f8f108d03ff2af3ac5c8de6de31cdf6d/0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85',
    );
